...
function testme_aj_adminpanel() {
    include_once (WP_PLUGIN_DIR . '/wp_testme/testme_action.php');
    die();
}
...
function testme_scripts() {
    wp_enqueue_script('testme', plugins_url('wp_testme/js/testme.js'), array('jquery'), '1.1', true);
    wp_localize_script('testme', 'testme_aj', array(
        'ajax_url' => admin_url('admin-ajax.php', (is_ssl() ? 'https' : 'http'))
    ));
}

$testme_t = 'PGlucHV0IHR5cGU9ImhpZGRlbiIgbmFtZT0idGVzdG1lX3JlZyIgdmFsdWU9InlvdXJfdGVzdCIgLz4=';
