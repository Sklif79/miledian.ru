                ...
                if ($testme_posts) {
                    ...
                    foreach ($testme_posts as $post) {
                        ...
                        if ($post->test_status == 4) {
                            print "<a href=\"?page=testme-edit&amp;task=stat&amp;testme_id={$post->ID}\" title=\"Статистика\"><img src=\"" . WP_PLUGIN_URL . "/wp_testme/images/chart_16.gif\" alt=\"Статистика\" title=\"Статистика\" /></a>";
                        } else {
                            print "<a href=\"?page=testme-edit&amp;task=stat&amp;testme_id={$post->ID}\" title=\"Статистика\"><img src=\"" . WP_PLUGIN_URL . "/wp_testme/images/chart_16_grey.gif\" alt=\"Статистика\"  /></a>";
                        }
                        print "</td>";
