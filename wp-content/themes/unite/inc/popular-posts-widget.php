        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">
                      <li class="active"><a href="#popular-posts" data-toggle="tab">Популярные</a></li>
                      <li><a href="#recent" data-toggle="tab">Последние</a></li>
            ...
            <div class="tab-content">
                <ul id="popular-posts" class="tab-pane active">
                    ...
                    <?php    
                        $recent_posts = new WP_Query(array('showposts' => $number, 'ignore_sticky_posts' => 1, 'post_status' => 'publish', 'order'=> 'DESC', 'showposts' => $number, 'meta_key' => 'post_views_count', 'orderby' => 'meta_value_num'));                    
                    ?>
                    ...
                    <?php while($recent_posts->have_posts()): $recent_posts->the_post(); ?>
                        <li>
                            ...
                            <div class="content">
                                ...
                                <span class="views-popular" title="Просмотры">
                                    <i class="fa fa-eye"></i>
