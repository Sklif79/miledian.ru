...
function unite_paging_nav() {
	...
	<nav class="navigation paging-navigation">
		<div class="screen-reader-text"><?php _e( 'Posts navigation', 'unite' ); ?></div>
		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"> <?php next_posts_link( __( '<i class="fa fa-chevron-left"></i> Старые записи', 'unite' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Новые записи <i class="fa fa-chevron-right"></i>', 'unite' ) ); ?> </div>
			<?php endif; ?>
...
function unite_post_nav() {
	...
	<nav class="navigation post-navigation">
		<div class="screen-reader-text"><?php _e( 'Post navigation', 'unite' ); ?></div>
		<div class="nav-links">
			<?php
