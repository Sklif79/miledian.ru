...
jQuery(document).ready(function () {
    ...
    function toggleUpButton() {
        if (jQuery(window).scrollTop() > 143 && jQuery(window).width() > 1199) {
            jQuery('nav.navbar').addClass('fixed-nav');
        } else if (jQuery(window).scrollTop() < 143 && jQuery(window).width() > 1199) {
            jQuery('nav.navbar').removeClass('fixed-nav');
        }
    ...
    jQuery('.rw-report-link').each(function (i, el) {
